...
// checks if the ApiLine type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ApiLine{}
...
func NewNullableApiLine(val *ApiLine) *NullableApiLine {
	return &NullableApiLine{value: val, isSet: true}
}
